...
type UserServiceClient interface {
	...
	GetUsersInfoWithOffset(ctx context.Context, in *GetUserWithOffsetIn, opts ...grpc.CallOption) (*GetUserWithOffsetOutAll, error)
}
...
func (c *userServiceClient) GetUsersInfoWithOffset(ctx context.Context, in *GetUserWithOffsetIn, opts ...grpc.CallOption) (*GetUserWithOffsetOutAll, error) {
	out := new(GetUserWithOffsetOutAll)
	err := c.cc.Invoke(ctx, "/UserService/GetUsersInfoWithOffset", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServiceServer interface {
	...
	GetUsersInfoWithOffset(context.Context, *GetUserWithOffsetIn) (*GetUserWithOffsetOutAll, error)
...
func (UnimplementedUserServiceServer) GetUsersInfoWithOffset(context.Context, *GetUserWithOffsetIn) (*GetUserWithOffsetOutAll, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetUsersInfoWithOffset not implemented")
}
...
func _UserService_GetUsersInfoWithOffset_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetUserWithOffsetIn)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServiceServer).GetUsersInfoWithOffset(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/UserService/GetUsersInfoWithOffset",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).GetUsersInfoWithOffset(ctx, req.(*GetUserWithOffsetIn))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetUsersInfoWithOffset",
			Handler:    _UserService_GetUsersInfoWithOffset_Handler,
		},
	},
